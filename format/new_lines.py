...
def new_lines(code, entry_point, ratio=0.5):
...
def new_line_aftercode(code, entry_point):
...
def indent_new_line_aftercode(code, entry_point):
...
def new_line_afterdoc(code, entry_point):
