...
def run_passatk_eval(
    ...
    local_evaluate_functional_correctness(
        output_samples_file, problem_file, language=language
    )
...
def local_evaluate_functional_correctness(
    ...
    command = f"evaluate_functional_correctness {output_samples_file} {problem_file} {language} 1,2,5,10,100,1000 64 "
